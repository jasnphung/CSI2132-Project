...
public class Hotel {
    ...
    public static String updateHotel(String chainName, String address, Long phoneNumber, String emailAddress, int starRating, int numberOfRooms, int managerID) throws Exception {
        Connection con = null;
        String message = "";
